...
@interface VideoEncoder()<AVCaptureVideoDataOutputSampleBufferDelegate>
{
@public
...
- (void)initVideoCaptrue
{
    ...
    // 设置录像分辨率
    [self.videoCaptureSession setSessionPreset:AVCaptureSessionPreset1920x1080];
...
-(void)startEncode
{
    ...
    [self startEncodeSession:1920 height:1080 framerate:25 bitrate:1920*10*1000];
...
- (void) writeH264Data:(char*)data length:(size_t)length addStartCode:(BOOL)b
{
    ...
    [[VideoDecoder share] decodeBuffer:h264Data.bytes length:h264Data.length];
